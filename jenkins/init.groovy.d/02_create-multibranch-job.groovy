...
def jobNames = ["bankapp", "keycloak", "accounts", "blocker", "cash", "exchange", "exchange_generator", "notifications", "transfer", "ui", "kafka", "zipkin", "grafana", "prometheus", "logstash", "elasticsearch", "kibana"]
